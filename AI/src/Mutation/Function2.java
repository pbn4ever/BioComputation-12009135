...
public class Function2 {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        if (open == false) {
            ...
            writer = new PrintWriter("5Rules, 1% Mutation, 10% Crossover, 100 Population - 1", "UTF-8");
            open = true;
        }
        readData();
        //setBinary();
...
fitness(i);
    ...
    public static void readData() throws FileNotFoundException {
        ...
        File text = new File("C:\\Users\\peter\\Documents\\NetBeansProjects\\AI\\build\\classes\\data/data2");
                ...
                for (int k = 0; k < rules; k++) {
                    for (int m = 0; m < length - 1; m++) {
                        if ((dataCheck[j][m] == population[i][(k * length) + m]) || (population[i][((k * length) + m)] == 2)) {
                            ...
                            counter++;
                            //System.out.println(population[i][(k * length) + m] + "\t" + dataCheck[j][m]);
                            if (counter == (length - 1 )) {
                              //  System.out.println(counter);
                                if ((dataCheck[j][length - 1]) == (population[i][(k * length) + (length - 1)])) {
                                    ...
                                    for (int w = 0; w < length; w++) {
                                      // System.out.print(population[i][(k*length) + w]);
                                    }
                                   // System.out.println("");
                           ...
                           // System.out.println("bitch" + counter);
                            m = length;
